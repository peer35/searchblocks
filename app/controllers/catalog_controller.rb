...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field 'keyword_sm', label: 'keyword', limit: true
    config.add_facet_field 'names_sm', label: 'creator', limit: true
    ...
    #   The ordering of the field names is the order of the display
    config.add_index_field 'names_sm', label: 'Creator'
    ...
    config.add_show_field 'also_sm', label: 'See also', :helper_method => :also_helper
    ...
    config.add_sort_field 'title_sort asc', label: 'term'
    config.add_sort_field 'date_dt desc', label: 'date (new - old)'
    config.add_sort_field 'date_dt asc', label: 'date (old - new)'
